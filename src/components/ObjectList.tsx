...
import BucketProperties from './BucketProperties';
import BucketPermissions from './BucketPermissions';
import BucketManagement from './BucketManagement';
import BucketAccessPoints from './BucketAccessPoints';
    ...
    return (
        ...
        >
            ...
            <div className="p-8 flex-1 overflow-x-hidden overflow-y-auto w-full max-w-full">
                ...
                {activeTab === 'metadata' && (
                    selectedBucket ? (
                        <BucketMetadata bucketName={selectedBucket} />
                    ) : (
                        <div className="flex items-center justify-center h-full">
                            <p className="text-slate-500">Please select a bucket to view metadata</p>
                        </div>
                    )
                )}
                ...
                {activeTab === 'properties' && (
                    selectedBucket ? (
                        <BucketProperties bucketName={selectedBucket} />
                    ) : (
                        <div className="flex items-center justify-center h-full">
                            <p className="text-slate-500">Please select a bucket to view properties</p>
                        </div>
                    )
                )}
                ...
                {activeTab === 'permissions' && (
                    selectedBucket ? (
                        <BucketPermissions bucketName={selectedBucket} />
                    ) : (
                        <div className="flex items-center justify-center h-full">
                            <p className="text-slate-500">Please select a bucket to view permissions</p>
                        </div>
                    )
                )}
                ...
                {activeTab === 'metrics' && (
                    selectedBucket ? (
                        ...
                        <div className="flex items-center justify-center h-full">
                            <p className="text-slate-500">Please select a bucket to view metrics</p>
                        </div>
                    )
                )}
                ...
                {activeTab === 'management' && (
                    selectedBucket ? (
                        <BucketManagement bucketName={selectedBucket} />
                    ) : (
                        <div className="flex items-center justify-center h-full">
                            <p className="text-slate-500">Please select a bucket to view management settings</p>
                        </div>
                    )
                )}
                ...
                {activeTab === 'access-points' && (
                    selectedBucket ? (
                        <BucketAccessPoints bucketName={selectedBucket} />
                    ) : (
                        <div className="flex items-center justify-center h-full">
                            <p className="text-slate-500">Please select a bucket to view access points</p>
                        </div>
                    )
                )}
            </div>
